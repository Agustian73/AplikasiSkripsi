...
import peramalan.models.ModelProses;
...
public class FrmProses extends javax.swing.JInternalFrame {
    ...
    public FrmProses() {
        ...
        //loadJenis();
//        tblPeramalan.setModel(model2);
//        model2.addColumn("Data Aktual");
//        model2.addColumn("Nilai Pemulusan");
//        model2.addColumn("Xt-Ft");
//        model2.addColumn("(Xt-Ft)^2");
        tblKayu();
        loadTblKayu();
    }

    public void tblKayu() {
        tblKayu.setModel(model1);
        model1.addColumn("Kode Kayu");
    ...
    private void initComponents() {
        ...
        FrmKayu = new javax.swing.JDialog();
        ...
        jScrollPane3.setViewportView(tblKayu);

        javax.swing.GroupLayout FrmKayuLayout = new javax.swing.GroupLayout(FrmKayu.getContentPane());
        FrmKayu.getContentPane().setLayout(FrmKayuLayout);
        FrmKayuLayout.setHorizontalGroup(
            FrmKayuLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jPanel6, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
            .addGroup(FrmKayuLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jScrollPane3)
                .addContainerGap())
        );
        FrmKayuLayout.setVerticalGroup(
            FrmKayuLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(FrmKayuLayout.createSequentialGroup()
        ...
        periode.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
                periodePropertyChange(evt);
            }
        });

        jLabel9.setFont(new java.awt.Font("Lucida Calligraphy", 0, 12)); // NOI18N
        jLabel9.setText("Periode Tgl. Akhir");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(periode, javax.swing.GroupLayout.PREFERRED_SIZE, 101, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(periode, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(1, 1, 1)), "Tabel Data Lampau", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, null, new java.awt.Color(0, 0, 0)));
        ...
        jPanel7.setBackground(new java.awt.Color(255, 78, 9));
    ...
    public void hitung() {  
        ...
        //txtHasil.setText(Float.valueOf(alpha).toString());

        tampilan += "\n";
        tampilan += "\tBerdasarkan perhitungan metode single exponential smoothing untuk jenis kayu " + kayu + "\n";
        tampilan += "\tdengan ukuran " + ukuran + " diprediksi periode berikutnya membutuhkan sebanyak " + Math.round(hasil) + " batang.\n";
        tampilan += "\n";
        tampilan += "\tDengan rincian :\n";
        tampilan += "\tHasil Peramalan = " + Math.round(hasil) + "\n";
        tampilan += "\tAlpha Terkecil = " + alpha + "\n";
        tampilan += "\tNilai Kesalahan Error(MSE) = " + hasil_mse + "\n";
        txtHasil.setText(tampilan);
        btnBatal.setEnabled(true);
        btnSimpan.setEnabled(true);
    }

    public void loadTblKayu() {
    ...
    private void btnLihatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLihatActionPerformed
        ...
        try {
            ...
            ResultSet t = m.read_data_lampau(txtKd.getText(), per);
            while (t.next()) {
    ...
    private void tblKayuMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblKayuMouseClicked
        // TODO add your handling code here:
        int i = tblKayu.getSelectedRow();
        String kode = (String) tblKayu.getValueAt(i, 0);
        kayu = (String) tblKayu.getValueAt(i, 1);
        ukuran = (String) tblKayu.getValueAt(i, 2);
        txtKd.setText(kode);
        FrmKayu.setVisible(false);
    }//GEN-LAST:event_tblKayuMouseClicked

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        FrmKayu.setBounds(300, 300, 472, 350);
        FrmKayu.setVisible(true);
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        if (!a.equals("")) {
            ...
            JOptionPane.showMessageDialog(null, "Inputkan semua data kayu", "Notifikasi", JOptionPane.INFORMATION_MESSAGE);
        }
    }//GEN-LAST:event_btnSimpanActionPerformed

    private void periodePropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_periodePropertyChange
        // TODO add your handling code here:
        if (periode.getDate() != null) {
            SimpleDateFormat Format = new SimpleDateFormat("yyyy-MM-dd");
            per = Format.format(periode.getDate());
        }
    }//GEN-LAST:event_periodePropertyChange


    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JDialog FrmKayu;

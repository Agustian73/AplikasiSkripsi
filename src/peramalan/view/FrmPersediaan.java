...
import peramalan.models.ModelPersediaan;
...
public class FrmPersediaan extends javax.swing.JInternalFrame {
    ...
    public FrmPersediaan() {
        ...
        model.addColumn("Kode Kayu");
        model.addColumn("Jenis Kayu");       
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Form Persediaan Kayu");
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtKodeKayu)
                            .addComponent(cbbJenis, 0, 388, Short.MAX_VALUE)))
                    .addGroup(jPanel3Layout.createSequentialGroup()
    ...
    public void loadId() {
        txtKodeKayu.setText(autoNumber());
    }
    ...
    public void loadJenis() {
        ...
        try {
            while (r.next()) {
                cbbJenis.addItem(r.getString("nama_jenis"));
            }
        } catch (SQLException ex) {
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        try {
            ...
            if (!a.equals("")) {
                ...
                JOptionPane.showMessageDialog(null, "nilai tidak boleh min");
            }
        } catch (SQLException ex) {
            Logger.getLogger(FrmPersediaan.class.getName()).log(Level.SEVERE, null, ex);
        }
